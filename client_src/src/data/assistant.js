export const sampleQuery = 'What is the strength of evidence linking V. Marchetti to the Aurora Holdings wire structuring, and what should we investigate next?';
...
export const relatedPersons = [
  { name: 'V. Marchetti', role: 'Assessed controller', conf: 'high', cites: [2, 6] },
  { name: 'R. Sable', role: 'Financial intermediary', conf: 'medium', cites: [1] },
  { name: 'L. Fenwick', role: 'Advisor (provisional)', conf: 'low', cites: [4] },
];
